...
INSERT INTO product
VALUES (1, 'Pork Shanghai Rolls', 75, 100, 20, 4, '', 'pieces');

INSERT INTO product
VALUES (2, 'Bangus Relleno Rolls', 85, 100, 15, 3, '', 'pieces');

INSERT INTO product
VALUES (3, 'Chicken Cordon Bleu Rolls', 85, 100, 10, 2, '', 'pieces');

INSERT INTO product
VALUES (4, 'Beef Taco Rolls', 90, 100, 20, 4, '', 'pieces');

INSERT INTO product
VALUES (5, 'Longganisa Rolls', 75, 100, 20, 4, '', 'pieces');

INSERT INTO product
VALUES (6, 'Tuna Ala King Rolls', 85, 100, 10, 3, '', 'pieces');

INSERT INTO product
VALUES (7, 'Cheese Samosa', 65, 100, 20, 2, '', 'pieces');

INSERT INTO product
VALUES (8, 'Vegetable Spring Rolls', 75, 100, 15, 3, '', 'pieces');

INSERT INTO product
VALUES (9, 'Bottled Water', 20, 100, 30, 1, '', 'bottles');

INSERT INTO product
VALUES (10, 'Lemon Iced Tea', 25, 100, 25, 1, '', 'bottles');
